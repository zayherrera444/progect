...
public class RobotContainer {
  ...
  DriveCommand driveForward = new DriveCommand(subsystem, true, .3);
  DriveCommand driveBack = new DriveCommand(subsystem, false, .3);
  // Replace with CommandPS4Controller or CommandJoystick if needed
  JoystickDrive command = new JoystickDrive(subsystem);
